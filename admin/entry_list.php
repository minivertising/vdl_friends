...
<div id="page-wrapper">
  ...
  <!-- Page Heading -->
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">VDL 이벤트 참여자 목록</h1>
      </div>
    </div>
    <!-- /.row -->
    <div class="row">
...
?>
              <tr>
                ...
                <td><?php echo $buyer_info[$key]['mb_url']?></td>
                <td><?php echo $buyer_info[$key]['mb_winner_url']?></td>
                <td><?php echo $buyer_info[$key]['mb_join']?></td>
                <td><?php echo $buyer_info[$key]['mb_use']?></td>
                <td><?php echo $buyer_info[$key]['mb_gubun']?></td>
                <td><?php echo $buyer_info[$key]['mb_joindate']?></td>
